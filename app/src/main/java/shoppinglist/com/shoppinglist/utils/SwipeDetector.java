package shoppinglist.com.shoppinglist.utils;
...
public class SwipeDetector implements View.OnTouchListener {
    ...
    public SwipeDetector(View convertView, ShoppingListAdapter adapter, ShoppingItem item) {
